...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius-md)] text-[length:var(--typography-size-sm)] font-[var(--typography-weight-medium)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: 'h-8 px-3 text-[length:var(--typography-size-xs)]',
        lg: 'h-12 px-8',
        icon: 'h-10 w-10',
      },
    },
