...
import {
  ...
  Settings, Zap, Target, Lightbulb, LayoutList, FileText, Star
} from 'lucide-react'
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/app/ranking-criativo', label: 'Ranking Criativo', icon: Star },
      { href: '/app/estrategia', label: 'Estratégia', icon: Target },
